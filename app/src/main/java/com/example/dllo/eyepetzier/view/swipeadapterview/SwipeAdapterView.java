package com.example.dllo.eyepetzier.view.swipeadapterview;
    ...
    private void adjustChildrenOfUnderTopView(float scrollRate) {
        ...
        if (count > 1) {
            ...
            for (; i < LAST_VIEW_IN_STACK; i++, multiple--) {
                ...
                Log.e("msg", SCALE_STEP * multiple + SCALE_STEP * rate+"");
//                underTopView.setScaleX(SCALE_STEP * multiple + SCALE_STEP * rate);
//                underTopView.setScaleY(SCALE_STEP * multiple + SCALE_STEP * rate);
            }
        }
    }
